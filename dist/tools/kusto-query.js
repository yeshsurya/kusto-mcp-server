...
export async function handleKustoQuery(params) {
    ...
    if (connectionName) {
        ...
        if (!connection) {
            throw createValidationError('No connection specified and no default connection configured. Use kusto_connection_add to create a connection.', 'connectionName');
        }
    }
    // Execute query
...
//# sourceMappingURL=kusto-query.js.map